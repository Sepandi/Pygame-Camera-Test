from pygame import font,Vector2,Surface
...
class Render():
    ...
    #--Text-Renderer
    def Text(fontName:font.Font,Word:str,Color,Position:Vector2,Window:Surface):
        #--Finds-Font-Type
    ...
    def PrintFPS(clock,win:Surface,Position:Vector2):
